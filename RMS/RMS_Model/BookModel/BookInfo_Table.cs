...
namespace RMS.Model
{
    public class BookInfo_Table
    {
        ...
        public BookInfo_Table()
        {
        }

        public BookInfo_Table(string bookGuid, string bookISBN, string bookRawName,
            string bookCNName, string bookAuthor,string bookPress,DateTime bookPubDate, 
            int bookNumber, DateTime bookBuyDate,string bookBuyPerson, string bookBuyShop, 
            string bookTypeGuid,string bookLanType, string bookAnnotation, bool bookIsDelete)
        {
            BookGuid = bookGuid;
            BookISBN = bookISBN;
